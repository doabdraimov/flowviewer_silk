...
$FlowViewer_server       = "FlowViewer.localhost"; # (IP address or hostname)
...
$work_directory          = "/var/www/html/Flow_Working";
...
$site_config_file        = "/opt/silk/etc/silk.conf";          # If left blank, will look for silk.conf in specified Data Rootdir (see User's Guide)
$sensor_config_file      = "/opt/silk/etc/sensor.conf";
$silk_compiled_localtime = "Y";          # Set to "Y" if you compiled SiLK with --enable-localtime switch
...
@devices                 = ("router_1"); # for flow-tools
@ipfix_devices           = ("Site");   # for SiLK, if none: @ipfix_devices = ();
...
$start_offset            = (5 * 60);   # e.g., 90 minutes ago
$end_offset              = (0 * 60);   # e.g., 30 minutes ago
$use_even_hours          = "N";
$N                       = 3;
$use_NDBM                = "N";
